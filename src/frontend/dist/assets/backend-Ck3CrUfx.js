...
import { W as ProtocolError, Y as TimeoutWaitingForResponseErrorCode, Z as utf8ToBytes, _ as ExternalError, $ as MissingRootKeyErrorCode, a0 as Certificate, a1 as lookupResultToBuffer, a2 as RequestStatusResponseStatus, a3 as UnknownError, a4 as RequestStatusDoneNoReplyErrorCode, a5 as RejectError, a6 as CertifiedRejectErrorCode, a7 as UNREACHABLE_ERROR, a8 as InputError, a9 as InvalidReadStateRequestErrorCode, aa as ReadRequestType, ab as Principal, ac as IDL, ad as MissingCanisterIdErrorCode, ae as HttpAgent, af as encode, ag as QueryResponseStatus, ah as UncertifiedRejectErrorCode, ai as isV3ResponseBody, aj as isV2ResponseBody, ak as UncertifiedRejectUpdateErrorCode, al as UnexpectedErrorCode, am as decode, an as Subscribable, ao as pendingThenable, ap as resolveEnabled, aq as shallowEqualObjects, ar as resolveStaleTime, as as noop, at as environmentManager, au as isValidTimeout, av as timeUntilStale, aw as timeoutManager, ax as focusManager, ay as fetchState, az as replaceData, aA as notifyManager, aB as hashKey, aC as getDefaultState, r as reactExports, aD as shouldThrowError, Q as useQueryClient, aE as useInternetIdentity, aF as createActorWithConfig, aG as Record, aH as Opt, aI as Variant, aJ as Vec, aK as Service, aL as Func, aM as Text, aN as Nat, aO as Principal$1, aP as Nat8, aQ as Null, aR as Bool, aS as Int, aT as Float64 } from "./index-Aguxj3OV.js";
...
Service({
  ...
  "addReview": Func([ProductId, Nat, Text], [Review], []),
  ...
  "deleteReview": Func([ReviewId], [], []),
  "deleteUserProfile": Func([Text], [], []),
  "getAllCarts": Func([], [Vec(CartEntry)], ["query"]),
  "getAllOrders": Func([], [Vec(Order)], ["query"]),
  "getAllReviews": Func([], [Vec(Review)], ["query"]),
  "getAllUsers": Func([], [Vec(UserEntry)], ["query"]),
  ...
  "getReviewsByProduct": Func([ProductId], [Vec(Review)], ["query"]),
  ...
  "removeAdminRole": Func([Principal$1], [], []),
  "removeFromCart": Func([Nat], [], []),
  "saveCallerUserProfile": Func([Text, Text], [UserProfile], []),
  "setAdminRole": Func([Principal$1], [], []),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const FragranceType2 = IDL2.Variant({
    "fresh": IDL2.Null,
    "floral": IDL2.Null,
    "citrus": IDL2.Null,
    "fougere": IDL2.Null,
  ...
  const CartEntry2 = IDL2.Record({ "cart": Cart2, "principalId": IDL2.Text });
  const UserProfile2 = IDL2.Record({
    "joinDate": Timestamp2,
    "name": IDL2.Text,
    "email": IDL2.Text
  });
  const UserEntry2 = IDL2.Record({
  ...
  const DashboardStats2 = IDL2.Record({
    ...
    "lowStockAlerts": IDL2.Vec(Product2),
  ...
  return IDL2.Service({
    ...
    "addReview": IDL2.Func([ProductId2, IDL2.Nat, IDL2.Text], [Review2], []),
    "addToCart": IDL2.Func([IDL2.Nat, IDL2.Nat], [], []),
    ...
    "createOrder": IDL2.Func([], [Order2], []),
    "createProduct": IDL2.Func([ProductInput2], [Product2], []),
    "deleteProduct": IDL2.Func([ProductId2], [IDL2.Bool], []),
    "deleteReview": IDL2.Func([ReviewId2], [], []),
    "deleteUserProfile": IDL2.Func([IDL2.Text], [], []),
    "getAllCarts": IDL2.Func([], [IDL2.Vec(CartEntry2)], ["query"]),
    "getAllOrders": IDL2.Func([], [IDL2.Vec(Order2)], ["query"]),
    "getAllReviews": IDL2.Func([], [IDL2.Vec(Review2)], ["query"]),
    "getAllUsers": IDL2.Func([], [IDL2.Vec(UserEntry2)], ["query"]),
    ...
    "getReviewsByProduct": IDL2.Func([ProductId2], [IDL2.Vec(Review2)], ["query"]),
    ...
    "removeAdminRole": IDL2.Func([IDL2.Principal], [], []),
    "removeFromCart": IDL2.Func([IDL2.Nat], [], []),
    "saveCallerUserProfile": IDL2.Func([IDL2.Text, IDL2.Text], [UserProfile2], []),
    "setAdminRole": IDL2.Func([IDL2.Principal], [], []),
...
class Backend {
  ...
  async addReview(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
async function from_candid_DashboardStats_n28(_uploadFile, _downloadFile, value) {
...
function from_candid_FragranceType_n21(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n22(_uploadFile, _downloadFile, value);
}
function from_candid_OrderStatus_n12(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function from_candid_Order_n10(_uploadFile, _downloadFile, value) {
  return from_candid_record_n11(_uploadFile, _downloadFile, value);
}
async function from_candid_Product_n19(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n13(_uploadFile, _downloadFile, value) {
  return "shipped" in value ? "shipped" : "cancelled" in value ? "cancelled" : "pending" in value ? "pending" : "delivered" in value ? "delivered" : "confirmed" in value ? "confirmed" : "processing" in value ? "processing" : value;
}
function from_candid_variant_n22(_uploadFile, _downloadFile, value) {
  return "fresh" in value ? "fresh" : "floral" in value ? "floral" : "citrus" in value ? "citrus" : "fougere" in value ? "fougere" : "oriental" in value ? "oriental" : "gourmand" in value ? "gourmand" : "chypre" in value ? "chypre" : "woody" in value ? "woody" : value;
}
...
function to_candid_FragranceType_n16(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function to_candid_OrderStatus_n37(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n38(_uploadFile, _downloadFile, value);
}
async function to_candid_ProductInput_n14(_uploadFile, _downloadFile, value) {
